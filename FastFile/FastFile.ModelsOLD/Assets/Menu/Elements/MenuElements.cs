...
namespace FastFile.ModelsOLD.Assets.Menu.Elements;
...
public class Window
{
    ...
    public XPointer<Material.Material> Background { get; set; } // Alias
}
...
public class ListBoxDef
{
    ...
    [XField(Offset = 0x154)]
    [XPointerField(ResolutionKind = PointerResolutionKind.Alias, Target = XPointerTarget.Object)]
    public XPointer<Material.Material> SelectIcon { get; set; } // Alias
}
