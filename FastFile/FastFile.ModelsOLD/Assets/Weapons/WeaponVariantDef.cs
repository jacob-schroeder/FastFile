using FastFile.ModelsOLD.Assets.Weapons.Enums;
...
public sealed class WeaponVariantDef() : BaseAsset(XAssetType.Weapon)
{
    ...
    public XPointer<Material.Material> killIcon { get; set; } = null!; // Alias

    [XField(Offset = 0x4C)]
    [XPointerField(ResolutionKind = PointerResolutionKind.Alias, Target = XPointerTarget.Object)]
    public XPointer<Material.Material> dpadIcon { get; set; } = null!; // Alias
