...
public sealed class FxElemDefVisuals
{
    ...
    public XPointer<MaterialAsset>? Material { get; set; }
    public XPointer<XModelAsset>? Model { get; set; }
...
public sealed class FxElemMarkVisuals
{
    ...
    public XPointer<MaterialAsset> Materials0 { get; set; } // Alias wrapper

    [XField(Offset = 0x04)]
    [XPointerField(ResolutionKind = PointerResolutionKind.Alias, Target = XPointerTarget.None)]
    public XPointer<MaterialAsset> Materials1 { get; set; } // Alias wrapper
}
