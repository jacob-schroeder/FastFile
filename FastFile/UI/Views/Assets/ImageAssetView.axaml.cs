...
public partial class ImageAssetView : UserControl
{
    ...
    private static KeyValueListItem[] BuildDetails(GfxImage image, ImageDecodeResult decoded)
    {
        ...
        [
            ...
            new("Map Type", AssetViewFormatters.FormatByte(image.MapType)),
            new("Semantic", AssetViewFormatters.FormatByte(image.Semantic)),
            new("Category", AssetViewFormatters.FormatByte(image.Category)),
            ...
            new("Card Memory", string.Join(", ", image.CardMemory.Select(value => value.ToString("N0", CultureInfo.CurrentCulture)))),
