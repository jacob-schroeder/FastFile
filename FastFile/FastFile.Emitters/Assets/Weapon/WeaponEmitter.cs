...
public sealed class WeaponEmitter : IXAssetEmitter<WeaponAsset>
{
    ...
    private static void EmitWeaponDefRoot(XEmitContext context, WeaponDef def, WeaponVariantDef owner)
    {
        ...
        context.Source.WriteSingle(def.TurnSpeedAndRange.MinTurnSpeed);
        context.Source.WriteSingle(def.TurnSpeedAndRange.MaxTurnSpeed);
        context.Source.WriteSingle(def.TurnSpeedAndRange.PitchConvergenceTime);
        context.Source.WriteSingle(def.TurnSpeedAndRange.YawConvergenceTime);
        context.Source.WriteSingle(def.TurnSpeedAndRange.SuppressTime);
        context.Source.WriteSingle(def.TurnSpeedAndRange.MaxRange);
        context.Source.WriteSingle(def.TurnSpeedAndRange.AnimationHorizontalRotateIncrement);
        context.Source.WriteSingle(def.TurnSpeedAndRange.PlayerPositionDistance);
        context.Source.WriteSingle(def.TurnSpeedAndRange.ScanSpeed);
        context.Source.WriteSingle(def.TurnSpeedAndRange.ScanAcceleration);
        ...
        context.Source.WriteInt32(def.Hints.UseHintStringIndex);
        context.Source.WriteInt32(def.Hints.DropHintStringIndex);
        context.Source.WriteSingle(def.Hints.HorizontalViewJitter);
        context.Source.WriteSingle(def.Hints.VerticalViewJitter);
        context.Source.WriteSingle(def.Hints.ScanSpeed);
        context.Source.WriteSingle(def.Hints.ScanAcceleration);
        context.Source.WriteInt32(def.Hints.ScanPauseTime);
        context.Source.WriteInt32(PointerRaw(def.ScriptName, def.ScriptNamePointer.Raw, "WeaponDef.scriptName"));
        context.Source.WriteSingle(def.OOPosAnimLength);
        context.Source.WriteSingle(def.MinDamage);
        context.Source.WriteInt32(def.MinPlayerDamage);
        context.Source.WriteSingle(def.MaxDamageRange);
        context.Source.WriteSingle(def.MinDamageRange);
        context.Source.WriteSingle(def.DestabilizationRateTime);
        context.Source.WriteSingle(def.DestabilizationCurvatureMax);
        context.Source.WriteSingle(def.DestabilizeDistance);
        context.Source.WriteInt32(def.DestabilizeDistanceToTimeScale);
        ...
        context.Source.WriteSingle(def.TurretScopeZoomRate);
        context.Source.WriteSingle(def.TurretScopeZoomMin);
        context.Source.WriteSingle(def.TurretScopeZoomMax);
        context.Source.WriteSingle(def.TurretOverheatUpRate);
        context.Source.WriteSingle(def.TurretOverheatDownRate);
        context.Source.WriteSingle(def.TurretOverheatPenalty);
        ...
        context.Source.WriteSingle(def.Turret.BarrelSpinSpeed);
        context.Source.WriteSingle(def.Turret.BarrelSpinUpTime);
        context.Source.WriteSingle(def.Turret.BarrelSpinDownTime);
        ...
        WriteFixedSoundAliasCells(context, def.Turret.BarrelSpinUpSoundNames, WeaponDef.TurretBarrelSpinSoundCount, "WeaponDef.turretBarrelSpinUp");
        WriteFixedSoundAliasCells(context, def.Turret.BarrelSpinDownSoundNames, WeaponDef.TurretBarrelSpinSoundCount, "WeaponDef.turretBarrelSpinDown");
    ...
    private static void EmitWeaponDefChildren(XEmitContext context, XBlockAddress root, WeaponDef def, WeaponVariantDef owner)
    {
        ...
        EmitSoundAliasCells(context, root.Add(0x5F8), def.Turret.BarrelSpinUpSoundNames);
        EmitSoundAliasCells(context, root.Add(0x608), def.Turret.BarrelSpinDownSoundNames);
